      ...
      <Card>
        <CardContent className="pt-6">
          {isLoading ? (<div className="text-center py-8 text-muted-foreground">Carregando...</div>) : (
            <Table>
              <TableHeader><TableRow><TableHead>Pedido</TableHead><TableHead>Cliente</TableHead><TableHead>Data Pedido</TableHead><TableHead>Status Bling</TableHead><TableHead className="text-right">Dias Corridos</TableHead><TableHead>Risco</TableHead></TableRow></TableHeader>
              <TableBody>
                {pedidos?.map((p) => (
